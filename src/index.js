 ...
 * logTwoResults()
 * ========================
 * Logs out the entire array of objects returned from the `finder()` 
 * function for two different people.
 *
...
function logTwoResults(person1, person2) {
  finder(person1.first, person1.last).then((eachResult) => {
    console.log(eachResult);

    finder(person2.first, person2.last).then((person2Result) => {
