...
function logThreeResultsCities(person1, person2, person3) {
  const allPromises = [person1, person2, person3].map( (a) => finder(a.first, a.last));

  Promise.all(allPromises).then( (passingData) =>{
    for(let arrOfObj of passingData){
      for (let objects of arrOfObj){
